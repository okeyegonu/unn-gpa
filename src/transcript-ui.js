...
export function initTranscript(opts) {
  ...
  function open() {
    // The programme length can change between one statement and the next.
    fillSelects();
    restoreDetails();
    renderCourses();
  ...
  function produce() {
    ...
    const t = buildTranscript({
      student, adviser, session, yearOfStudy: year, programmeYears: denominator,
